<template>
  <div class="q-pa-md">
    ...
    <q-card class="q-mt-sm q-mb-sm">
      <q-card-section>
        <div class="text-h6">{{ _$t("options") }}</div>
      </q-card-section>
      <q-card-section>
        <div class="row q-mb-xs">
          <div class="col">
            <q-toggle
              v-model="_propsRef.modelValue.includeFilesInSubFolders"
              :label="_$t('includeFilesInSubfolders')"
              left-label
              dense
            />
          </div>
        ...
        <div class="row q-mb-xs">
          <div class="col">
            <q-toggle
              v-model="_propsRef.modelValue.skipEmptyFolders"
              :label="_$t('skipEmptyFolders')"
              left-label
              dense
            />
          </div>
        ...
        <div class="row q-mb-xs">
          <div class="col">
            <q-toggle
              v-model="_propsRef.modelValue.storeFullPath"
              :label="_$t('storeFullPath')"
              left-label
              dense
            />
          </div>
        ...
        <div class="row q-mb-xs">
          <div class="col">
            <q-select
              v-model="_propsRef.modelValue.ifArchiveExists"
              :options="_ifArchiveExistsOptions"
              :label="_$t('ifDestinationArchiveExists')"
              dense
              lazy-rules
              map-options
              emit-value
        ...
        <div class="row q-mb-xs">
          <div class="col">
            <q-select
              ...
              :options="_compressionLevelExistsOptions"
              :label="_$t('compressionLevel')"
              dense
              lazy-rules
              map-options
              emit-value
...
const _ifArchiveExistsOptions = [
  {
    label: _$t("addOrOverwriteFilesInTheArchive"),
    value: "AddOrOverwriteFilesInTheArchive",
  },
  { label: _$t("createWithUniqueNames"), value: "CreateWithUniqueNames" },
  { label: _$t("fail"), value: "Fail" },
];

const _compressionLevelExistsOptions = [
  {
    label: _$t("low"),
    value: "Low",
  },
  { label: _$t("medium"), value: "Medium" },
  { label: _$t("high"), value: "High" },
];
</script>
